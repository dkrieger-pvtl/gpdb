        ...
        try:
            for segmentPair in gpArray.getSegmentList():
                ...
                if self.__options.hba_hostnames:
                    ...
                    segment_pair_ips = gp.IfAddrs.list_addrs(segmentPair.mirrorDB.getSegmentHostName())
                    segment_pair_ips.extend(gp.IfAddrs.list_addrs(segmentPair.primaryDB.getSegmentHostName()))
