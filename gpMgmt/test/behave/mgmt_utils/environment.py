...
def before_feature(context, feature):
    ...
    if 'gpexpand' in feature.tags or 'gpaddmirrors' in feature.tags or 'gpstate' in feature.tags or 'gpmovemirrors' in feature.tags:
        return
...
def before_scenario(context, scenario):
    if 'gpexpand' in context.feature.tags or 'gpaddmirrors' in context.feature.tags or 'gpstate' in context.feature.tags or 'gpmovemirrors' in context.feature.tags:
        return
